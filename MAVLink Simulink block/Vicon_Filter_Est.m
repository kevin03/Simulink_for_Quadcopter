function Vicon_Filter_Est(block)
...
function DoPostPropSetup(block)
  ...
  block.Dwork(3).Name            = 'ViconPoseOlder'; 
...
function Update(block)
  ...
  ZNew         = ViconPoseNew(3);
  ViconPoseOlder = block.Dwork(3).Data;
  ...
  if (abs(YawNew - YawOld) < 30*pi/180 &&  ZNew ~= 0 ) 
      ...
      block.Dwork(1).Data(1)=2*ViconPoseOld(1)-ViconPoseOlder(1);
      block.Dwork(1).Data(2)=2*ViconPoseOld(2)-ViconPoseOlder(2);
      block.Dwork(1).Data(3)=2*ViconPoseOld(3)-ViconPoseOlder(3);
