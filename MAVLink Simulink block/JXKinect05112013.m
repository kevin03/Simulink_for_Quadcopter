...
Output_GetSegmentGlobalTranslation = MyClient.GetSegmentGlobalTranslation('JianXing', 'JianXing');
...
% Euler Angles
QuadEulerXYZ = MyClient.GetSegmentGlobalRotationEulerXYZ('JianXing', 'JianXing');
